...
const car33year = inventory[32]["car_year"];
console.log(car33year);

const car33make = inventory[32]["car_make"];
console.log(car33make);

const car33model = inventory[32]["car_model"];
console.log(car33model);
...
console.log(lastCarIndex);

const lastCarMake = inventory[49]["car_make"];
console.log(lastCarMake);

const lastCarModel = inventory[49]["car_model"];
...
const sortedCarYears = carYears.sort();
